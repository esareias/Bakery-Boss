...
const SvgPatterns = () => (
  React.createElement("svg", { width: "0", height: "0", className: "absolute opacity-0 pointer-events-none" },
    React.createElement("defs", null,
      ...
      React.createElement("pattern", { id: "cyberPattern", patternUnits: "objectBoundingBox", width: "0.1", height: "0.1", viewBox: "0 0 10 10", preserveAspectRatio: "none" },
      ...
      React.createElement("pattern", { id: "glitchPattern", patternUnits: "objectBoundingBox", width: "0.2", height: "0.2", viewBox: "0 0 20 20", preserveAspectRatio: "none" },
...
const TOOLS = {
    ...
    'spatula': { id: 'spatula', name: 'Spatula', icon: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-utensils-crossed"><path d="M14.5 4h-5L7 7H4a2 2 2 0 0 0-2 2v1a6 6 0 0 0 6 6h1l3 3"/><path d="m3 21 6-6"/></svg>') 16 16, auto`, cost: 300 },
